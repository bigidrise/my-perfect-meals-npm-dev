  ...
  return <main className="min-h-100dvh overflow-y-auto bg-gradient-to-br from-black via-orange-950/90 to-black pb-safe-nav text-white">
    ...
    <div className="relative mx-auto max-w-5xl px-4 pb-28 pt-[calc(env(safe-area-inset-top)+2rem)] sm:px-8 sm:pt-12">
      <header className="max-w-3xl">
        ...
        <h1 className="text-4xl font-black leading-[0.98] tracking-[-0.045em] text-white sm:text-6xl">Tell us what you actually enjoy eating.</h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/70 sm:text-lg">There is no perfect answer here. Choose the foods, dishes, and flavors that feel like you — the everyday ones and the just-for-fun ones.</p>
      </header>
