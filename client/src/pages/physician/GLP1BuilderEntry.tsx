...
export default function GLP1BuilderEntry() {
  ...
  const handlePerformance = useCallback(async () => {
    await setMode(true);
    setLocation(hasSchedule ? "/glp1-hub" : "/glp1/training");
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white font-semibold text-base leading-tight mb-0.5">
              Continue to GLP-1 Hub
            </p>
            <p className="text-white text-sm leading-relaxed">
              View your GLP-1 nutrition hub, generate meals using your baseline macro targets.
            </p>
          </div>
        ...
        <div className="mt-6 mb-4">
          ...
          <p className="text-white text-sm leading-relaxed">
            Set up your Training Nutrition Schedule so your meals automatically adapt to your workout schedule while continuing to honor your GLP-1 nutrition protocol.
          </p>
        </div>
