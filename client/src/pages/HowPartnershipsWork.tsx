...
const PARTNER_TYPES = [
  {
    ...
    doesNotGet: ["Organization team management", "Product placement"],
  ...
  },
  {
    ...
    doesNotGet: ["Organization team management (unless added)"],
    accent: "border-white/15 bg-white/5",
    iconColor: "text-orange-400",
    iconBg: "bg-white/10",
  },
  {
    ...
    gets: [
      "Organization Dashboard and professional team management",
