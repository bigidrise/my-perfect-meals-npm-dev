...
// Start Here → opens ChefCoPilotWalkthrough (9-step guided tour for prospective partners).
// Kitchen directory fetches from /api/kitchens/featured.
...
import {
  ...
  ArrowLeft, ArrowRight, Globe, Layers, Star,
} from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 space-y-2">
        ...
        <div
          className="flex items-center gap-1 text-xs font-medium pt-0.5"
          style={{ color: primary }}
        >
...
export default function SignatureKitchenHubPage() {
  ...
  const [hasDismissed] = useState(() => localStorage.getItem(DISMISS_KEY) === "true");
  ...
  function handleApply() {
    ...
    window.location.href = "mailto:partnerships@myperfectmeals.com?subject=Signature Kitchen Application";
  }
  function handleBook() {
    setWalkthroughOpen(false);
    window.location.href = "mailto:partnerships@myperfectmeals.com?subject=Signature Kitchen Discovery Call";
  }
  function handleContact() {
    setWalkthroughOpen(false);
    window.location.href = "mailto:partnerships@myperfectmeals.com?subject=Signature Kitchen Inquiry";
  }
  ...
  return (
    ...
    >
      {/* Back nav */}
      <div
        className="fixed top-0 left-0 right-0 z-20 flex items-center px-4"
      ...
      >
        ...
        <div
          className="relative px-6 pb-10 max-w-xl mx-auto"
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-orange-500/70">
              My Perfect Meals
            </span>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => setLocation(activeKitchens.length > 0 ? `/kitchen/${activeKitchens[0].slug}` : "/lifestyle")}
      ...
      <div className="max-w-xl mx-auto px-4 py-6 space-y-8">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #ea580c0d 0%, #0a0a0a 100%)",
        ...
        >
          ...
          <div className="space-y-5">
            <HowItWorksStep
              ...
              body="Real dishes, sauces, techniques, and recipes form the foundation of your kitchen's identity."
              color="#ea580c"
            />
            <HowItWorksStep
              number="02"
              ...
              body="The platform extends your style — generating personalized meals for every user in your kitchen's voice."
              color="#f97316"
            />
            <HowItWorksStep
              number="03"
              ...
              body="Your style shapes the experience. The platform handles each user's health protocols, dietary rules, and medical guidelines."
              color="#10b981"
            />
            <HowItWorksStep
              number="04"
              ...
              body="Every dish generated in your kitchen carries your fingerprint — reaching users at a scale that's impossible through content alone."
              color="#ea580c"
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-white">Active Kitchens</h2>
          </div>
          ...
          {loadingKitchens ? (
            <div className="flex gap-3 overflow-hidden">
              {[0, 1].map(i => (
                <div
                  key={i}
                  className="rounded-2xl flex-shrink-0 w-64 h-52 animate-pulse"
              ...
              <div className="flex gap-3 pb-2" style={{ width: "max-content" }}>
                {activeKitchens.map(k => (
                  <KitchenCard
                    key={k.slug}
                    kitchen={k}
                    onNavigate={() => setLocation(`/kitchen/${k.slug}`)}
                  />
                ))}
              </div>
            </div>
            ...
            <div
              ...
              style={{ borderColor: "#ea580c25" }}
            >
              <ChefHat className="h-10 w-10 text-orange-500 opacity-20" />
              <div>
                <p className="text-white/50 text-sm font-medium">Kitchens opening soon</p>
                <p className="text-white/25 text-xs mt-1 leading-relaxed">
                  The first Signature Kitchens are in final onboarding. Be first to partner.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white/45 text-xs mt-0.5 leading-relaxed">
                    Submit your chef identity, brand assets, and content catalog. Our team reviews every application.
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/35 text-xs mt-1 leading-relaxed">Talk with our partnerships team before submitting.</p>
                </div>
                <button
                  type="button"
                  onClick={handleBook}
