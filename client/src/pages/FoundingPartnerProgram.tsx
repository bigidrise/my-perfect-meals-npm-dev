    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="bg-orange-50 border border-orange-200 rounded-2xl p-5 text-center"
        >
          <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center mx-auto mb-3">
            <Star className="h-6 w-6 text-orange-500" />
          </div>
          <h2 className="text-gray-900 font-bold text-base mb-1">Intentionally Limited</h2>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">How Organizations Participate</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
            There are two tracks inside this program: <span className="text-orange-600 font-medium">Founding Affiliate Partner</span> and <span className="text-gray-700 font-medium">Founding Business Partner</span>. Both involve direct collaboration with the MPM team. The key difference is the workload — and therefore the investment.
          </p>

          {/* Path 1 — Founding Affiliate */}
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-3">
            <div className="text-orange-600 text-xs font-bold uppercase tracking-wider mb-2">Founding Affiliate Partner</div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed mb-2">Partners in this pathway receive</p>
            ...
            <div className="mt-4 bg-orange-100 border border-orange-200 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-orange-700 text-xs font-bold uppercase tracking-wider">Founding Affiliate Commission</span>
              </div>
              <div className="flex items-center gap-3 mb-3">
                <div className="flex-1 text-center bg-orange-200 border border-orange-300 rounded-lg py-2.5">
                  <div className="text-2xl font-black text-orange-700">60%</div>
                  <div className="text-[10px] text-orange-600 font-medium mt-0.5">My Perfect Meals</div>
                </div>
                <div className="text-gray-400 text-xs font-bold">/</div>
                <div className="flex-1 text-center bg-white border border-gray-200 rounded-lg py-2.5">
                  <div className="text-2xl font-black text-gray-600">40%</div>
                  <div className="text-[10px] text-gray-500 font-medium mt-0.5">You Earn</div>
                </div>
              </div>
              <p className="text-gray-600 text-xs leading-relaxed mb-1.5">
                Founding Affiliates earn a <span className="text-gray-800 font-semibold">40% recurring commission</span> on every subscription they refer — a strong rate that reflects the value and trust we place in founding partners.
              </p>
            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              {["Coaches", "Educators", "Influencers", "Health Professionals", "Membership Communities"].map((t, i) => (
                <span key={i} className="text-[10px] bg-orange-50 border border-orange-200 text-orange-600 rounded-full px-2.5 py-0.5">{t}</span>
              ))}
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
            <div className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-2">Founding Business Partner</div>
            <p className="text-gray-600 text-sm leading-relaxed mb-3">
            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              {["Clinics", "Practices", "Wellness Organizations", "Healthcare Companies", "Multi-Provider Businesses"].map((t, i) => (
                <span key={i} className="text-[10px] bg-gray-100 border border-gray-200 text-gray-500 rounded-full px-2.5 py-0.5">{t}</span>
              ))}
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">What Is a Founding Business Partner?</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <TrendingUp className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Why We Created This Program</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-3">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <Users className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Ideal Founding Business Partners</h3>
          </div>
          <div className="flex flex-wrap gap-2">
            {WHO_FOR.map((role, i) => (
              <span key={i} className="text-xs bg-gray-100 border border-gray-200 text-gray-600 rounded-full px-3 py-1">
                {role}
              </span>
            ))}
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Founding Business Partner Benefits</h3>
          </div>
          <div className="space-y-3">
            {BENEFITS.map((b, i) => (
              <div key={i} className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-gray-900 text-sm font-medium leading-snug">{b.label}</div>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <CheckCircle2 className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">What Implementation Includes</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-3">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">What We Expect</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <CheckCircle2 className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">What Happens After Acceptance?</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
          ...
          <p className="text-gray-400 text-xs uppercase tracking-wider font-semibold mb-3">A typical implementation may include</p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="bg-gray-50 border border-gray-100 rounded-xl p-3">
                <div className="text-orange-600 text-xs font-semibold mb-2">{block.phase}</div>
                <div className="space-y-1">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <TrendingUp className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Brand & Marketing Alignment</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
          ...
          <p className="text-gray-400 text-xs uppercase tracking-wider font-semibold mb-2">As part of implementation, organizations may receive</p>
          <div className="space-y-1.5 mb-4">
            {[
              "Marketing guidance",
          ...
          <div className="space-y-3 border-t border-gray-100 pt-4">
            <div>
              <p className="text-gray-700 text-sm font-medium leading-snug mb-1">My Perfect Meals is not marketed as a weight-loss product.</p>
              <p className="text-gray-500 text-xs leading-relaxed">
            ...
            <div>
              <p className="text-gray-700 text-sm font-medium leading-snug mb-1">Brand standards apply when the platform is represented publicly.</p>
              <p className="text-gray-500 text-xs leading-relaxed">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Why Founding Partners Pay</h3>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed mb-3">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <Star className="h-4 w-4 text-orange-500 flex-shrink-0" />
            <h3 className="text-gray-900 font-semibold text-sm uppercase tracking-wider">Founding Partner Investment</h3>
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-3">
            <div className="text-orange-600 text-xs font-bold uppercase tracking-wider mb-3">Founding Affiliate Partner</div>
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-gray-900 font-black text-2xl">$197</span>
              <span className="text-gray-400 text-sm">/ month</span>
            </div>
            <div className="text-orange-500 text-xs font-semibold mb-3">No setup fee</div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
            <div className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-3">Founding Business Partner</div>
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                <div className="text-gray-400 text-xs mb-0.5">Setup Investment</div>
                <div className="text-gray-900 font-black text-lg">$1,500 – $3,000</div>
                <div className="text-gray-400 text-xs">one-time</div>
              </div>
              <div>
                <div className="text-gray-400 text-xs mb-0.5">Monthly</div>
                <div className="text-gray-900 font-black text-lg">$297 – $997</div>
          ...
          <p className="text-gray-400 text-xs leading-relaxed mt-3 border-t border-gray-100 pt-3">
        ...
        >
          <h3 className="text-orange-700 font-bold text-sm mb-1">Apply for Founding Business Partner Consideration</h3>
