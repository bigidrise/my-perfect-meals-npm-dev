      ...
      >
        ...
        >
          ...
          <div className="relative mb-4">
            ...
            />
            <Card
              className="relative cursor-pointer transition-all duration-300 hover:scale-[1.02] active:scale-95 bg-black/30 backdrop-blur-lg border border-pink-400/30 rounded-xl shadow-md overflow-hidden hover:shadow-[0_0_30px_rgba(236,72,153,0.4)] hover:border-pink-500/50"
              ...
              <CardContent className="p-3">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2">
                    <Sparkles className="h-4 w-4 flex-shrink-0 text-pink-500" />
