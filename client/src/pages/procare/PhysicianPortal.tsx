    ...
    >
      ...
      >
        <div className="grid grid-cols-3 gap-3">
          <Card
            className="bg-blue-600/20 border border-blue-500/30 cursor-pointer hover:bg-blue-600/30 transition-all"
          ...
          >
            <CardContent className="p-4 flex flex-col items-center gap-2 text-center">
              ...
              <div>
                ...
                <div className="text-xs text-white/70">Glycemic control</div>
              </div>
            </CardContent>
          </Card>
          <Card
          ...
          >
            <CardContent className="p-4 flex flex-col items-center gap-2 text-center">
              ...
              <div>
                ...
                <div className="text-xs text-white/70">Medication support</div>
              </div>
            </CardContent>
          </Card>
          <Card
          ...
          >
            <CardContent className="p-4 flex flex-col items-center gap-2 text-center">
              ...
              <div>
                ...
                <div className="text-xs text-white/70">Therapeutic</div>
              </div>
            </CardContent>
          </Card>
        </div>
