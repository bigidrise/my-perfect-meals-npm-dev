// 🔒🔒🔒 FAST FOOD GUIDE - CLONE OF RESTAURANT GUIDE 🔒🔒🔒
// STATUS: Exact clone with Fast Food branding — same engine, same logic
//
...
const CACHE_KEY = "fastFoodGuide.cache.v1";
...
export default function FastFoodGuidePage() {
  ...
  const generateMealsMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        title: "🍟 Fast Food Options Generated!",
