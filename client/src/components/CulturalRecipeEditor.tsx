...
export function CulturalRecipeEditor({ 
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="flex flex-col max-w-4xl w-[calc(100vw-2rem)] h-[90vh] overflow-hidden bg-gradient-to-br from-purple-900 to-indigo-900 text-white border-purple-700">
