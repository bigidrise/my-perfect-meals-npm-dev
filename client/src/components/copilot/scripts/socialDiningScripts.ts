...
export const FIND_MY_MEAL_ENTRY =
  "Welcome to Find My Meal. Let's find you some healthy options at nearby restaurants.";
...
export const FIND_MY_MEAL_GENERATING =
  "I'm searching within a five-mile radius for three restaurants and suggesting two meals per restaurant with healthy ordering tips.";
...
export const RESTAURANT_GUIDE_GENERATING =
  "I'm pulling three meals from this restaurant’s cuisine and showing you how to order them to fit your plan.";
