...
Here's how to get started. First, invite clients into your studio. Then set their nutrition targets. Next, assign them a meal builder. And finally, guide, review, and adjust their plans over time.

Inside you'll find tools for macro and calorie targets, builder assignment, client activity history, and nutrition adjustment tools. Tap Enter Workspace when you're ready to begin.`;
...
Here's how to get started. First, review patient nutrition context. Then select appropriate nutrition hubs. Next, apply safety guardrails. And finally, monitor nutrition adherence over time.

Inside you'll find condition-specific nutrition hubs, guardrails configuration, clinical nutrition builders, and patient nutrition activity logs. Tap Enter Workspace when you're ready to begin.`;
