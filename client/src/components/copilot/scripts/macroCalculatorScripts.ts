...
export const MACRO_CALC_NUTRITION_STRATEGY =
  "Before we lock your starch game in, let's dial in your Nutrition Strategy. Cut Intensity controls how aggressive your deficit is — Standard is the default balanced approach. Hard Cut steps it up: choose Balanced to keep things moderate, or Low Carb to push carbs lower and raise fat to keep you full. Cycle Mode lets you vary macros day to day — Carb Cycling takes starchy carbs to zero on Low days and boosts them on High days, Fat Cycling does the same thing with fat instead. You can also set a hard ceiling on starchy carbs with the Starchy Carb Cap if you want extra control. Strict Mode is for competition prep or ProCare use — it disables all auto-corrections. When you've made your selections, tap Continue.";
