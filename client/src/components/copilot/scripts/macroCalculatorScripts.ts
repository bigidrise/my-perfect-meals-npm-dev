...
export const MACRO_CALC_BODY_TYPE = 
  "Got it. Now, what's your body type? This helps me fine-tune your metabolism. Are you naturally lean, medium build, or do you tend to hold onto weight easier?";

export const MACRO_CALC_UNITS = 
  "Quick one — do you prefer imperial or metric? Pounds and inches, or kilos and centimeters?";

export const MACRO_CALC_SEX = 
  "Next — and this is for metabolic calculations — are you male or female?";
...
export const MACRO_CALC_SYNC_WEIGHT = 
  "Would you like me to sync this weight with your tracking? Optional, but it helps keep things consistent.";
...
export const MACRO_CALC_RESULTS = 
  "And here are your personalized macros! These are calculated based on everything you just told me.";

export const MACRO_CALC_STARCH = 
  "One more thing — how do you want to handle starchy carbs? Do you want them with every meal, just one or two meals, or are you keeping them minimal?";

export const MACRO_CALC_SAVE = 
  "Perfect! Hit save and you're all set. Your macros are locked in.";

export const MACRO_CALC_DONE = 
  "Nice work! Your personalized macro targets are ready to go. Let's build some meals!";
