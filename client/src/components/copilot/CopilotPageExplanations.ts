...
"Care Team and ProAccess lets you connect with the people who support your goals. You can invite a trainer, physician, coach, patient, or client by email and assign their role, or join someone else’s team using an access code. Once connected, you’ll appear on each other’s active care team, making it easy to collaborate, share progress, and manage support in one place. You can update or manage your care team at any time, so choose the option that fits what you want to do and get started.",
  ...
  "/pro/clients/:id/diabetic-builder": {
    ...
    spokenText:
      "This diabetic meal builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and guidelines you’ve already defined, using either the AI Meal Creator to select ingredients with the meal picker or Create With Chef to describe meals and snacks and let the Chef build them. You can build one or multiple days, adjust servings, and generate breakfast, lunch, dinner, and snacks, then save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. If you’re the client, this is where you build meals using your coach’s guidelines, following the targets shown at the bottom of the screen, creating your day with the AI Meal Creator or Create With Chef, and saving your meals to Biometrics with the option to add ingredients to your shopping list. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. The asterisks next to protein and carbs are intentional — those are the two most important numbers to hit each day. Calories and fats still matter, but protein and carbs drive energy, recovery, and performance, so they’re the priorities to focus on. When you’re ready, tap Save Day to lock everything into Biometrics.",
    autoClose: true,
  },
  ...
  "/pro/clients/:id/general-nutrition-builder": {
    ...
    spokenText:
      "This general nutrition meal builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and guidelines you’ve already defined, using either the AI Meal Creator to select ingredients with the meal picker or Create With Chef to describe meals and snacks and let the Chef build them. You can build one or multiple days, adjust servings, and generate breakfast, lunch, dinner, and snacks, then save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. If you’re the client, this is where you build meals using your coach’s guidelines, following the targets shown at the bottom of the screen, creating your day with the AI Meal Creator or Create With Chef, and saving your meals to Biometrics with the option to add ingredients to your shopping list. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. The asterisks next to protein and carbs are intentional — those are the two most important numbers to hit each day. Calories and fats still matter, but protein and carbs drive energy, recovery, and performance, so they’re the priorities to focus on. When you’re ready, tap Save Day to lock everything into Biometrics.",
    autoClose: true,
  },
};
