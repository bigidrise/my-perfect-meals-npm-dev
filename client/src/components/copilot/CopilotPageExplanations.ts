...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/weekly-meal-board": {
    ...
    spokenText:
      "Welcome to the Weekly Meal Builder. This is where everything comes together. No matter which builder you’re using, they all work the same way; you’re creating meals in any cuisine or style you want, using a flexible Meal 1, Meal 2, Meal 3 structure, with the ability to add more meals as needed based on how you eat. At the top of the screen, you’ll see your daily nutrition targets, which come from the Macro Calculator and serve as your baseline for the day, and at the bottom, you’ll see your Nutrition Budget, a real-time view of what you have remaining for protein, starchy carbs, and fiber as you add meals, helping you stay on track without overthinking. Just below the top section is your daily starch indicator, showing how many starchy meals, you have available based on the strategy you set in the Macro Calculator, with green meaning you still have starch meals available and orange meaning you have already used them. Starch Guard is your built-in weight management system, limiting high-glycemic carbs like rice, pasta, and potatoes, and when you have used your starch meals, it steps in and helps you substitute with fibrous carb options or lets the Chef choose for you. To start building, tap Create with Chef, our multilingual, multi-cuisine AI meal creator, and describe what you want — you can keep it simple or be highly detailed, but the more specific you are about cuisine, protein, carbs, and preferences, the more tailored your results will be. If you want tighter control, use the Keep It Simple option to limit extra ingredients and keep the meal focused on exactly what you asked for. You can plan a full week, build each day differently, or duplicate days to save time, and as you build, focus on protein and carbs since they drive your results. When you are finished, you can send meals to your shopping list, log your day to Biometrics, or make changes anytime. This is your builder - create meals the way you eat, then connect everything through Biometrics and your Shopping List to see the system work. If you are a guest, building at least one meal here unlocks Fridge Rescue and Craving Creator, so focus on creating a meal you would eat and adding it to your day. ",
    autoClose: true,
    guestDescription:
