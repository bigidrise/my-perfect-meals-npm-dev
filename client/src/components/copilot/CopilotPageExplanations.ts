...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/glp1-hub": {
    ...
    description:
      "Your Metabolic Medication support hub for shot tracking, guardrails, and meal readiness.",
    spokenText:
