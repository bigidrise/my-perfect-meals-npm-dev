...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/lifestyle/my-perfect-gatherings": {
    ...
    description:
      "Plan full multi-course meals for holidays, camping, tailgates, Great Outdoors, and group events — with AI-generated courses that feel chef-designed, not random.",
    spokenText:
      "Welcome to My Perfect Gatherings. This is where meal planning meets real life. Think of it as a personal chef who designs the entire meal around what you are actually doing and who you are doing it with. You pick the situation — a holiday like Thanksgiving or Hanukkah, a camping trip, a tailgate, a Great Outdoors harvest meal, or a family gathering — and then set the details: how many people you are feeding and how many courses you want. From there, I build each course individually — appetizer, main, sides, dessert — so every dish feels intentional, balanced, and connected to the same occasion. Nothing random, nothing repeated. Each course knows what the others are. And one thing worth knowing: your dietary preferences travel with you into every single course. If you are vegan, every course will be plant-based. If you are keto, gluten-free, kosher, halal, or anything else, your protocol is enforced across your full gathering automatically. You do not need to remind me. It is already built in. If you choose Great Outdoors, there is something special that happens first. Before any meal cards appear, I generate a Harvest-to-Table Guide for your protein — whether that is venison, wild turkey, trout, elk, or anything else you harvested. It covers field handling, cleaning, preparation, storage, and food safety in plain language, so you know exactly what to do before you ever fire up the smoker or cast iron. Then I build the full multi-course meal around your protein, your cooking method, and your dietary protocol. Harvest to table. Start to finish. In one experience.",
    autoClose: true,
  },
