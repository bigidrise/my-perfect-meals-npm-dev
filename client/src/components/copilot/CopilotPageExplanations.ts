...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/weekly-meal-board": {
    ...
    spokenText:
"Welcome to the Weekly Meal Builder. All meal builders throughout the app work the same way, with guardrails based on the board you’re using. Start by choosing how you want to build your meals — tap Create with Chef to describe what you want, and let the AI Chef build it for you. You can also use the plus button to’d rather describe what you want and let the Chef build it for you. From there, choose how many days you want to plan and decide how you want to eat on each of those days, so you can structure your week one way and eat differently on weekends if you choose. Build out each day with breakfast, lunch, dinner, and snacks, making adjustments to the meals themselves rather than traditional serving sizes. Prep cards are available when needed to control how foods are prepared or to dial in targets like protein amount, helping you fine-tune meals without changing the overall structure of the day. To save time, you can duplicate a full day and copy those meals to other days of the week. As you build, you’ll notice Protein and Carbs are marked with an asterisk, because those are your primary focus macros and have the biggest impact on energy, performance, and body composition. You can send your day to the Macro Calculator to track nutrition or send ingredients straight to your shopping list to build groceries automatically. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. The asterisks next to protein and carbs are intentional — those are the two most important numbers to hit each day. Calories and fats still matter, but protein and carbs drive energy, recovery, and performance, so they’re the priorities to focus on. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/diabetic-menu-builder": {
    ...
    spokenText:
    "The Diabetic Meal Builder works just like the other builders, using performance-focused guardrails to support training, recovery, and body composition. Start by choosing how you want to build your meals — tap Create with Chef to describe what you want, and let the AI Chef build it for you. You can also use the plus button to’d rather describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how you want to eat on each of those days, so you can structure weekdays one way and approach weekends differently if you choose. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving adjustments. Prep options are available when needed to control how foods are prepared or to dial in targets like protein amount, helping you fine-tune meals without changing the overall structure. As you build, you’ll notice protein and carbs are marked with an asterisk, because those are the primary macros to focus on and the biggest drivers of energy, recovery, and results, while calories and fats still matter but play a supporting role. You can send meals to your macro table to track nutrition, send ingredients directly to your shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/glp1-meal-builder": {
    ...
    spokenText:
    "The GLP-1 Meal Builder works just like the other builders, using performance-focused guardrails to support training, recovery, and body composition. Start by choosing how you want to build your meals — tap Create with Chef to describe what you want, and let the AI Chef build it for you. You can also use the plus button to’d rather describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how you want to eat on each of those days, so you can structure weekdays one way and approach weekends differently if you choose. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving adjustments. Prep options are available when needed to control how foods are prepared or to dial in targets like protein amount, helping you fine-tune meals without changing the overall structure. As you build, you’ll notice protein and carbs are marked with an asterisk, because those are the primary macros to focus on and the biggest drivers of energy, recovery, and results, while calories and fats still matter but play a supporting role. You can send meals to your macro table to track nutrition, send ingredients directly to your shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
  ...
  "/anti-inflammatory-menu-builder": {
    ...
    spokenText:
    "The Anti-Inflammatory Meal Builder works just like the other builders, using performance-focused guardrails to support training, recovery, and body composition. Start by choosing how you want to build your meals — tap Create with Chef to describe what you want, and let the AI Chef build it for you. You can also use the plus button to’d rather describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how you want to eat on each of those days, so you can structure weekdays one way and approach weekends differently if you choose. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving adjustments. Prep options are available when needed to control how foods are prepared or to dial in targets like protein amount, helping you fine-tune meals without changing the overall structure. As you build, you’ll notice protein and carbs are marked with an asterisk, because those are the primary macros to focus on and the biggest drivers of energy, recovery, and results, while calories and fats still matter but play a supporting role. You can send meals to your macro table to track nutrition, send ingredients directly to your shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
  ...
  "/beach-body-meal-board": {
    ...
    spokenText:
    "The Beach Body Meal Builder works just like the other builders, using performance-focused guardrails to support training, recovery, and body composition. Start by choosing how you want to build your meals — tap Create with Chef to describe what you want, and let the AI Chef build it for you. You can also use the plus button to’d rather describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how you want to eat on each of those days, so you can follow a more structured approach during the week and shift things on the weekends if you choose. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving adjustments. Prep options are available when needed to control how foods are prepared or to dial in targets like protein amount, helping you fine-tune meals while staying aligned with your training goals. As you build, you’ll notice protein and carbs are marked with an asterisk, because those are the primary macros to focus on and the biggest drivers of energy, recovery, and physique results, while calories and fats still matter but play a supporting role. You can send meals to your macro table to track nutrition, send ingredients directly to your shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
...
"Care Team and ProAccess lets you connect with the people who support your goals. You can invite a trainer, physician, coach, patient, or client by email and assign their role, or join someone else’s team using an access code. Once connected, you’ll appear on each other’s active care team, making it easy to collaborate, share progress, and manage support in one place. You can update or manage your care team at any time, so choose the option that fits what you want to do and get started.",
  ...
  "/pro/clients/:id/diabetic-builder": {
    ...
    spokenText:
      "The Diabetic Meal Builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and clinical guidelines you’ve already defined, using either the AI Meal Creator to select specific ingredients or Create With Chef to describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how each day should be structured, allowing flexibility when needed while staying within the approved medical framework. Build out each day with breakfast, lunch, dinner, and snacks, making adjustments to the meals themselves rather than traditional serving manipulation. Prep options are available to control how foods are prepared and to dial in targets such as protein amounts, helping ensure meals remain compliant with diabetic guidelines. If you’re the client, this is where you build meals using your coach’s or physician’s settings, following the targets shown at the bottom of the screen and creating your day with the AI Meal Creator or Create With Chef. You can save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets, and the asterisks next to protein and carbs are intentional, as those are the primary numbers used to manage energy, glucose response, and overall control, while calories and fats still matter but play a supporting role. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/pro/clients/:id/glp1-builder": {
    ...
    spokenText:
      "The GLP-1 Meal Builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and clinical guidelines you’ve already defined, using either the AI Meal Creator to select specific ingredients or Create With Chef to describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how each day should be structured, allowing flexibility while staying aligned with GLP-1-specific goals such as satiety, protein prioritization, and meal consistency. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving manipulation. Prep options are available to control how foods are prepared and to dial in targets like protein amount, helping support fullness, adherence, and metabolic response. If you’re the client, this is where you build meals using your coach’s or physician’s settings, following the targets shown at the bottom of the screen and creating your day with the AI Meal Creator or Create With Chef. You can save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets, and the asterisks next to protein and carbs are intentional, as those are the primary numbers used to support satiety, energy stability, and lean tissue preservation, while calories and fats still matter but play a supporting role. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/pro/clients/:id/anti-inflammatory-builder": {
    ...
    spokenText:
      "The Anti-Inflammatory Meal Builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and clinical guidelines you’ve already defined, using either the AI Meal Creator to select specific ingredients or Create With Chef to describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how each day should be structured, allowing flexibility while staying aligned with anti-inflammatory goals such as nutrient quality, food variety, and consistency. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving manipulation. Prep options are available to control how foods are prepared and to support anti-inflammatory strategies like cooking methods, ingredient choices, and protein targets. If you’re the client, this is where you build meals using your coach’s or physician’s settings, following the targets shown at the bottom of the screen and creating your day with the AI Meal Creator or Create With Chef. You can save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets, and the asterisks next to protein and carbs are intentional, as those are the primary numbers used to support recovery, energy stability, and tissue repair, while calories and fats still matter but play a supporting role. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/pro/clients/:id/performance-competition-builder": {
    ...
    spokenText:
      "The Performance and Competition Meal Builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and performance guidelines you’ve already defined, using either the AI Meal Creator to select specific ingredients or Create With Chef to describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how each day should be structured, allowing flexibility while staying aligned with training demands, competition schedules, and recovery needs. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving manipulation. Prep options are available to control how foods are prepared and to dial in targets such as protein amount, helping support performance output, recovery, and body composition. If you’re the client, this is where you build meals using your coach’s or physician’s settings, following the targets shown at the bottom of the screen and creating your day with the AI Meal Creator or Create With Chef. You can save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets, and the asterisks next to protein and carbs are intentional, as those are the primary numbers that drive energy availability, recovery, and competitive performance, while calories and fats still matter but play a supporting role. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day.",
    autoClose: true,
  },
  ...
  "/pro/clients/:id/general-nutrition-builder": {
    ...
    spokenText:
      "The General Nutrition Meal Builder is used under ProCare to create meals within the guardrails set by a coach or physician. As a professional, this is where you build meals for a client based on the targets, protocols, and nutrition guidelines you’ve already defined, using either the AI Meal Creator to select specific ingredients or Create With Chef to describe meals and snacks and let the Chef build them for you. From there, choose how many days you want to plan and decide how each day should be structured, allowing flexibility while staying aligned with the established nutrition framework. Build out each day with breakfast, lunch, dinner, and snacks, making changes to the meals themselves rather than traditional serving manipulation. Prep options are available when needed to control how foods are prepared or to dial in targets such as protein amount, helping ensure meals remain practical, balanced, and consistent. If you’re the client, this is where you build meals using your coach’s or physician’s settings, following the targets shown at the bottom of the screen and creating your day with the AI Meal Creator or Create With Chef. You can save a full day to Biometrics to log macros, send ingredients to the shopping list, or do both. At the bottom of the page, you’ll see a macro progress bar with a green line that fills as you get closer to your daily targets, and the asterisks next to protein and carbs are intentional, as those are the primary numbers that support energy, recovery, and overall nutritional balance, while calories and fats still matter but play a supporting role. When you’re ready, tap the Save Day to Biometrics button to save and lock in your day. I don't wanna go through it",
    autoClose: true,
  },
};
