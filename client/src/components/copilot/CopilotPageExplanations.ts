...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/weekly-meal-board": {
    ...
    description:
      "Build meals across one or multiple days guided by your goals. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
  ...
  "/diabetic-menu-builder": {
    ...
    description:
      "Build meals that support balanced blood sugar with GlucoseGuard™ protection. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically.",
    spokenText:
  ...
  "/glp1-meal-builder": {
    ...
    description:
      "Create portion-aware meals designed to support GLP-1 goals. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
  ...
  "/anti-inflammatory-menu-builder": {
    ...
    description:
      "Build meals focused on inflammation-friendly ingredients. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
  ...
  "/beach-body-meal-board": {
    ...
    description:
      "Create structured meals designed for performance and body composition. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
  ...
  "/performance-competition-builder": {
    ...
    description:
      "Build precision performance meals for training and competition. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
  ...
  "/pro/general-nutrition-builder": {
    ...
    description:
      "Build balanced, everyday meals for sustainable nutrition. Each meal slot has a My Favorites button — tap the red star to instantly reuse any saved meal with macros updated automatically. Taste Memory is active — the more you save, the more the app learns your preferences.",
    spokenText:
