...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  "/dashboard": {
    ...
    spokenText:
      "Welcome to My Perfect Meals. Before we get started, let me introduce Chef Copilot, your built-in guide. You can use Chef manually or hands-free at any time. If hands-free is on, Chef will automatically guide you through each step as you move through the app. If it’s off, Chef stays quiet until you open Copilot and press Listen, and you can turn hands-free on or off or close Copilot whenever you want. This is your dashboard, your home base, where you can plan meals, track macros, handle cravings, and manage your lifestyle tools. When creating meals, you don’t need to be perfect — simple requests work, and more detail just helps refine the result. You can ask for a Mediterranean lunch, or you can specify protein, carbs, and dietary needs, and Chef will build it exactly the way you want, across any cuisine or diet. To get started, open the Macro Calculator and set your daily targets, and from there I’ll guide you through building your meals, with or without hands-free.",
    autoClose: true,
  },
