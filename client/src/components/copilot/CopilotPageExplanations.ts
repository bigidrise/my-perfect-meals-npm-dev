...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/lifestyle/ultimate-experiences": {
    ...
    spokenText:
      "Welcome to Ultimate Experiences. This is where meal planning becomes something more than just nutrition. Think of it as a personal chef who designs the entire experience around what you're actually doing and who you're doing it with. You pick the situation, a holiday like Thanksgiving or Hanukkah, a camping trip, a date night, a family gathering, or something more personal, and then set the details: how many people you're feeding, how many courses you want, and the flavor direction you're going for. From there, I build each course individually — appetizer, main, sides, dessert — so every dish feels intentional, balanced, and connected to the same experience. Nothing random, nothing repeated. Each course knows what the others are. And one thing worth knowing: your dietary preferences travel with you into every single course. If you are vegan, every course will be plant-based — the appetizer, the main, the sides, the dessert, all of it. If you are keto, gluten-free, kosher, halal, pescatarian, or anything else, your protocol is enforced across the full experience automatically. You do not need to remind me. It is already built in. You can even pin specific dishes to a course, paste in a family recipe, or let me build the entire meal from scratch. When it is ready, every course appears as a full meal card with ingredients, instructions, and nutrition. You can log any course to your plan, save favorites, or share the full experience. This is not a meal generator. This is how you eat when it matters.",
    autoClose: true,
  },
