...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/lifestyle": {
    ...
    spokenText:
      "Welcome to the Lifestyle Hub, where everything comes together for real life. From here you can enjoy your cravings in a healthier way, turn what’s in your fridge into meals, find smarter options when eating out, choose meals for kids or toddlers, and explore drink choices in the Spirits and Lifestyle Hub. You can also jump into Chef’s Kitchen to create custom meals, experiment with ideas, and cook with guidance when you want more control or creativity. This space is here to help you enjoy food, social time, and nights out without stress, guilt, or overthinking — so explore what you need and enjoy yourself.",
    autoClose: true,
  },
