...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/craving-creator": {
    ...
    spokenText:
      "Craving Creator is for those moments when you want something specific, but still want it to fit your goals. Just tell me what you’re craving — sweet, crunchy, creamy, or anything else. Add any preferences or restrictions, choose how many servings you want, and tap Create. I’ll build a balanced version of that craving with ingredients, nutrition, and instructions. When you find a meal you like, you can add it straight to today's plan.  Use the Flavor Preference toggle to switch between Personal — using your saved palate preferences — or Neutral for light seasoning when cooking for others. Pro tip — you can go hands-free here. Tap the Chef, and just talk your way through it.",
    autoClose: true,
    guestDescription:
