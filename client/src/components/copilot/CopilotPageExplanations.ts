...
export const PAGE_EXPLANATIONS: Record<string, metricPageExplanation> = {
  "/my-biometrics": {
    ...
    spokenText:
"This is your Biometrics page, where everything you eat and track rolls up into your daily totals. When you send your macros here from the Macro Calculator, they become your persistent daily targets and stay locked in until you change them again. As you log meals, macros, or photo entries, everything is tracked against those numbers automatically. If you’re short on protein or carbs, you can top off your day by choosing a quick food source, like Whey for a protein shake, and tapping add to apply the correct macros. You can also log meals manually, bring them in from meal cards, or use Log from Photo, where AI estimates the macros for you. Once entries appear, just tap add to include them, and you can delete or reset anything at any time. Your calories are tracked for today, the past week, and up to thirty days so you can easily spot trends. You can also log your body weight and view progress across one month, three months, six months, or up to a full year, and at the bottom of the page you’ll find your water log to track hydration throughout the day.",
    autoClose: true,
  },
