...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  ...
  "/social-hub": {
    ...
    spokenText:
      "Meals Away From Home. In this feature, you have two ways to find healthy meals. Use Restaurant Guide when you already know where you’re eating, just tell me the restaurant, and what you want. Or use Find Healthy Options to search by zip code, and see what’s around you. Tap whichever one you need.",
    autoClose: true,
  },
