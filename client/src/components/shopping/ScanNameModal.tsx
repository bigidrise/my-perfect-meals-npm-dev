          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4">
              <input
                ...
                className="flex-1 bg-black/60 border border-white/20 rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-orange-500/60 caret-white"
              />
              <button
                onClick={startVoice}
                disabled={listening}
