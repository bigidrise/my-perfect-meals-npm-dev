...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/business-center/affiliate/social/certification", label: "Social — Cert Dashboard" },
      { path: "/business-center/affiliate/social/certification/module-1", label: "Social — Phase 1 Lesson" },
      { path: "/business-center/affiliate/social/certification/module-1/quiz", label: "Social — Phase 1 Quiz" },
      { path: "/business-center/affiliate/social/certification/module-2", label: "Social — Phase 2 Lesson" },
      { path: "/business-center/affiliate/social/certification/module-2/quiz", label: "Social — Phase 2 Quiz" },
      { path: "/business-center/affiliate/social/certification/module-3", label: "Social — Phase 3 Lesson" },
      { path: "/business-center/affiliate/social/certification/module-3/quiz", label: "Social — Phase 3 Quiz" },
      { path: "/business-center/affiliate/social/certification/final-assessment", label: "Social — Final Assessment" },
      { path: "/business-center/affiliate/social/certification/complete", label: "Social — Cert Complete" },
      { path: "/business-center/affiliate/social/certification/view", label: "Social — Certificate View" },
      { path: "/business-center/affiliate/coaching/certification", label: "Coaching — Cert Dashboard" },
      { path: "/business-center/affiliate/coaching/certification/module-1", label: "Coaching — Phase 1 Lesson" },
      { path: "/business-center/affiliate/coaching/certification/module-1/quiz", label: "Coaching — Phase 1 Quiz" },
      { path: "/business-center/affiliate/coaching/certification/module-2", label: "Coaching — Phase 2 Lesson" },
      { path: "/business-center/affiliate/coaching/certification/module-2/quiz", label: "Coaching — Phase 2 Quiz" },
      { path: "/business-center/affiliate/coaching/certification/module-3", label: "Coaching — Phase 3 Lesson" },
      { path: "/business-center/affiliate/coaching/certification/module-3/quiz", label: "Coaching — Phase 3 Quiz" },
      { path: "/business-center/affiliate/coaching/certification/final-assessment", label: "Coaching — Final Assessment" },
      { path: "/business-center/affiliate/coaching/certification/complete", label: "Coaching — Cert Complete" },
      { path: "/business-center/affiliate/coaching/certification/view", label: "Coaching — Certificate View" },
    ],
  },
  {
    title: "Other",
