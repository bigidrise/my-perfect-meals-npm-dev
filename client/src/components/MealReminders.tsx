  ...
  return (
    <div className="flex items-center gap-2 py-2 border-b border-white/10 last:border-b-0">
      ...
      <input
        ...
        disabled={disabled}
        className="bg-white/10 border border-white/30 rounded-full px-2.5 py-0.5 text-white text-[11px] focus:outline-none focus:ring-1 focus:ring-orange-500 disabled:opacity-40 flex-shrink-0"
      />
