  ...
  },
  {
    ...
    quiz: {
      ...
      questions: [
        ...
        {
          id: "m4q4",
          question: "Why was My Perfect Meals created?",
          options: [
            "To eliminate the need for coaches",
            "To simplify and manage nutrition complexity",
            "To reduce the number of meal choices",
            "To focus only on weight loss",
          ],
          correctIndex: 1,
          explanation: "My Perfect Meals was created to simplify and manage nutrition complexity so that professionals can focus on helping people succeed rather than manually solving every food problem.",
        },
        {
          id: "m4q5",
          question: "According to this lesson, the most successful coaches spend the majority of their time:",
          options: [
            "Creating meal plans",
            "Building recipes",
            "Helping people change behaviors and achieve consistency",
            "Calculating calories",
          ],
          correctIndex: 2,
          explanation: "The most successful coaches focus on behavior, consistency, and accountability — not on meal planning. The platform handles the food mechanics so coaches can focus on people.",
        },
      ],
    },
  },
  {
    ...
    quiz: {
      ...
      questions: [
        ...
        {
          id: "m5q5",
          question: "Which statement best reflects the philosophy of this lesson?",
          options: [
            "Perfect compliance is required for success.",
            "The professional should manually solve every nutrition problem.",
            "The best coaches help clients improve the lifestyle they already have.",
            "Clients should immediately eliminate all favorite foods.",
          ],
          correctIndex: 2,
          explanation: "The best coaches don't overhaul a client's entire life. They help clients improve what already exists — making the process sustainable, enjoyable, and consistent.",
        },
      ],
    },
  },
  ...
  },
  {
    ...
    quiz: {
      ...
      questions: [
        ...
        {
          id: "m7q2",
          question: "Why is certification required before becoming an approved affiliate, provider, or business partner?",
          options: [
            "To make participation more difficult",
            "To identify individuals who are serious about learning and building a business",
            "To reduce the number of affiliates",
            "To increase platform revenue",
          ],
          correctIndex: 1,
          explanation: "Certification exists to identify people who are serious. If someone is unwilling to invest time learning the system, they are unlikely to invest the effort required to build a successful business.",
        },
        {
          id: "m7q3",
        ...
        {
          id: "m7q5",
          question: "According to the lesson, what is one of the most important drivers of long-term business growth?",
          options: [
          ...
          correctIndex: 2,
          explanation: "Trust creates relationships. Relationships create referrals. Referrals create growth. The strongest opportunities come from existing clients, referrals, and professional relationships built over time.",
        },
      ],
    },
  },
