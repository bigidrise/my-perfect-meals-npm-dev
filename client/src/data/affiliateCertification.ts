...
export const AFFILIATE_MODULES: CertificationModule[] = [
  ...
  {
    id: "module-4",
    title: "Representing the My Perfect Meals Brand",
    description: "How to explain My Perfect Meals clearly, avoid misleading claims, and build trust with clients and partners.",
    estimatedMinutes: 15,
    sections: [
      {
        heading: "Why This Module Matters",
        text: "One of the most important responsibilities you have is representing My Perfect Meals accurately.\n\nWhether you're talking to a potential client, a gym owner, a physician, a business, or simply sharing the platform on social media, the way you explain My Perfect Meals matters.\n\nThe goal isn't to convince people to use the platform through hype or exaggerated claims. The goal is to clearly explain what the platform does, who it helps, and why it's different.\n\nBy the end of this module, you'll know how to confidently represent the My Perfect Meals brand while staying accurate, professional, and trustworthy.",
      },
      {
        heading: "Sell the Problem, Not the App",
        text: "People don't wake up wanting another nutrition app. They want solutions.\n\nSome people are tired of trying different diets. Some don't know what to eat. Some eat out too often. Some have medical concerns. Others simply want nutrition that fits their busy lives.\n\nInstead of leading with features, begin by understanding their problem. Once you understand what they're struggling with, explain how My Perfect Meals helps solve that specific challenge.",
        tip: "People buy solutions — not software.",
      },
      {
        heading: "Explain Features as Benefits",
        text: "My Perfect Meals has many powerful features. But people don't care about features until they understand how those features help them.\n\nInstead of saying: \"Recipe Scan uses AI.\"\nSay: \"Recipe Scan helps you understand recipes faster and gives personalized suggestions based on your profile.\"\n\nInstead of saying: \"We have a Restaurant Guide.\"\nSay: \"The Restaurant Guide helps people make better choices when eating out.\"\n\nInstead of listing features, explain how each one makes life easier.",
        tip: "Always answer one question: \"Why does this feature matter to the user?\"",
      },
      {
        heading: "What NOT to Say",
        text: "Representing the brand also means knowing what not to promise.\n\nInstead, explain what the platform actually does — it personalizes nutrition based on the user's information and helps people make better food decisions.\n\nLet the platform earn the results.",
        list: [
          "Do not promise guaranteed weight loss",
          "Do not promise disease reversal",
          "Do not promise medical treatment",
          "Do not promise instant results",
          "Do not say My Perfect Meals replaces doctors or dietitians",
        ],
        tip: "Never promise an outcome you cannot guarantee. Promise the experience — not the result.",
      },
      {
        heading: "Explaining AI the Right Way",
        text: "Many people hear the words \"Artificial Intelligence\" and assume the platform simply generates random meals. That's not how My Perfect Meals works.\n\nThe AI uses the information the user provides to create recommendations that fit their profile. The better the information, the better the recommendations.\n\nA simple explanation is:\n\n\"My Perfect Meals uses AI together with your personal profile to create recommendations that are built specifically for you.\"\n\nThat explanation is simple, accurate, and easy to understand.",
        tip: "Keep AI simple. People care much more about what it does than how it works.",
      },
      {
        heading: "Building Trust",
        text: "People work with people they trust. Trust comes from honesty, consistency, and realistic expectations.\n\nIf you don't know the answer to a question, it's okay to say: \"That's a great question. Let me find the correct answer.\"\n\nYou don't have to know everything. You simply need to represent the platform honestly.\n\nA confident, honest explanation builds more trust than exaggerated promises ever will.",
        tip: "The strongest marketing tool you have is credibility. Protect it.",
      },
      {
        heading: "Key Takeaways",
        list: [
          "Focus on solving problems, not selling software.",
          "Explain benefits before features.",
          "Never promise guaranteed results.",
          "Keep AI explanations simple and accurate.",
          "Build trust through honesty and consistency.",
          "Protect the My Perfect Meals brand every time you talk about it.",
        ],
      },
    ],
    quiz: {
      ...
      questions: [
        {
          id: "m4q1",
          question: "A potential client says, \"Why should I use My Perfect Meals?\" What is the best response?",
          options: [
            "\"Because it has more features than every other app.\"",
            "\"Because it helps personalize nutrition around your goals, preferences, and lifestyle instead of giving everyone the same advice.\"",
            "\"Because it's guaranteed to help you lose weight.\"",
            "\"Because everyone else is using it.\"",
          ],
          correctIndex: 1,
          explanation: "Focus on what the platform actually does — personalize nutrition for each individual. That's an honest, specific answer that builds trust.",
        },
        {
          id: "m4q2",
          question: "When introducing My Perfect Meals, what should you focus on first?",
          options: [
            "Every feature inside the app.",
            "The user's problem and how the platform helps solve it.",
            "Subscription pricing.",
            "AI technology.",
          ],
          correctIndex: 1,
          explanation: "Start with the person's problem, then explain how the platform solves it. People buy solutions, not software.",
        },
        {
          id: "m4q3",
          question: "Which statement is appropriate?",
          options: [
            "\"My Perfect Meals guarantees results.\"",
            "\"My Perfect Meals replaces your physician.\"",
            "\"My Perfect Meals personalizes nutrition to help users make better food decisions.\"",
            "\"Everyone using My Perfect Meals loses weight.\"",
          ],
          correctIndex: 2,
          explanation: "This statement is accurate and honest. It describes what the platform actually does without making claims you cannot guarantee.",
        },
        {
          id: "m4q4",
          question: "A client asks how the AI works. Which response is best?",
          options: [
            "\"It creates random meal plans.\"",
            "\"It uses your profile information to create recommendations that fit your goals and preferences.\"",
            "\"It's too technical to explain.\"",
            "\"It knows everything automatically.\"",
          ],
          correctIndex: 1,
          explanation: "Keep AI simple. The accurate explanation is that it uses the user's profile to create personalized recommendations. That's what matters to the client.",
        },
        {
          id: "m4q5",
          question: "A coach wants to list every feature during the first conversation. What is the better approach?",
          options: [
            "Explain every feature immediately.",
            "Focus on the person's needs and introduce the features that solve those needs.",
            "Skip talking about the platform.",
            "Only discuss pricing.",
          ],
          correctIndex: 1,
          explanation: "Lead with the problem, then introduce the features that are relevant to that person. Overwhelming someone with features creates confusion, not confidence.",
        },
        {
          id: "m4q6",
          question: "Which statement should you avoid?",
          options: [
            "\"The platform personalizes nutrition.\"",
            "\"The Restaurant Guide helps you make better choices when eating out.\"",
            "\"My Perfect Meals guarantees you'll lose 20 pounds.\"",
            "\"The platform adapts to your goals.\"",
          ],
          correctIndex: 2,
          explanation: "Never promise outcomes you cannot guarantee. Guaranteed weight loss claims damage trust and misrepresent what the platform does.",
        },
        {
          id: "m4q7",
          question: "A business owner asks if My Perfect Meals replaces registered dietitians. What is the best response?",
          options: [
            "\"Yes.\"",
            "\"Sometimes.\"",
            "\"No. It supports personalized nutrition but does not replace licensed healthcare professionals.\"",
            "\"Only for healthy people.\"",
          ],
          correctIndex: 2,
          explanation: "My Perfect Meals supports personalized nutrition but does not replace licensed healthcare professionals. Always be accurate about what the platform is and is not.",
        },
        {
          id: "m4q8",
          question: "What is one of the best ways to build trust?",
          options: [
            "Promise fast results.",
            "Be honest about what the platform does and does not do.",
            "Avoid answering difficult questions.",
            "Compare My Perfect Meals negatively against competitors.",
          ],
          correctIndex: 1,
          explanation: "Trust is built through honesty and realistic expectations. A confident, honest explanation builds more trust than exaggerated promises ever will.",
        },
      ],
    },
  },
  {
    id: "module-5",
    title: "Helping Clients Succeed with My Perfect Meals",
    description: "How to help clients start strong, stay consistent, and get the most from the platform.",
    estimatedMinutes: 15,
    sections: [
      {
        heading: "Why This Module Matters",
        text: "A great coach doesn't simply tell people what to eat.\n\nA great coach helps people build habits, stay consistent, and make better decisions over time.\n\nMy Perfect Meals handles the nutrition guidance. Your role is to help people use the platform successfully and stay engaged with the process.\n\nBy the end of this module, you'll understand how to help clients get the most from My Perfect Meals while building confidence and long-term success.",
      },
      {
        heading: "Start with a Strong Foundation",
        text: "The client experience begins long before the first meal is created.\n\nHelping someone complete their profile accurately is one of the most valuable things you can do. Encourage clients to answer the onboarding questions honestly and completely. Their goals, food preferences, allergies, dietary style, and health information all help the platform create better recommendations.\n\nA strong foundation leads to a better experience from the very beginning.",
        tip: "Never rush onboarding. Spending a few extra minutes helping a client complete their profile can improve every recommendation the platform makes.",
      },
      {
        heading: "Don't Overwhelm New Clients",
        text: "My Perfect Meals includes many powerful features, but new users don't need to learn everything on day one.\n\nStart with the basics. Help them understand how to create meals, save favorites, and build confidence using the platform.\n\nAs they become more comfortable, introduce additional tools like the Restaurant Guide, Shopping List, Recipe Scan, Ingredient Intelligence, and Weekly Meal Board.\n\nLearning one step at a time creates a better experience than trying to master everything at once.",
        tip: "Teach what the client needs today. Tomorrow's lessons can wait until tomorrow.",
      },
      {
        heading: "Progress Beats Perfection",
        text: "No one eats perfectly every day.\n\nPeople travel. They celebrate birthdays. They eat at restaurants. They miss workouts. Life happens.\n\nThe goal of My Perfect Meals is not perfection. The goal is helping people make better food decisions more consistently.\n\nEncourage clients to focus on progress rather than feeling discouraged by occasional setbacks.",
        tip: "One less-than-perfect meal does not erase weeks of good decisions. Help clients keep moving forward instead of starting over.",
      },
      {
        heading: "The Platform and the Coach Work Together",
        text: "My Perfect Meals and the coach each have an important role.\n\nThe platform personalizes nutrition recommendations. The coach provides encouragement, accountability, education, and support.\n\nTogether, they create a better experience than either could provide alone.\n\nThe platform helps answer \"What should I eat?\"\n\nThe coach helps answer \"How do I stay consistent?\"",
        tip: "Let the technology do the heavy lifting so you can focus on building relationships and supporting your clients.",
      },
      {
        heading: "Know When to Refer",
        text: "While My Perfect Meals can support many nutrition goals, there are times when additional professional guidance is appropriate.\n\nIf a client has questions outside your scope of practice or requires medical advice, encourage them to speak with the appropriate licensed healthcare professional.\n\nKnowing when to refer is part of being a trusted professional. Clients appreciate honesty, and working alongside other healthcare providers helps create the best possible experience.",
        tip: "Being a great coach doesn't mean having every answer. It means knowing when to involve the right professional.",
      },
      {
        heading: "Key Takeaways",
        list: [
          "A successful client experience begins with accurate onboarding.",
          "Introduce features gradually instead of overwhelming new users.",
          "Encourage progress and consistency rather than perfection.",
          "The platform handles personalized nutrition; the coach provides accountability and support.",
          "Refer clients to licensed professionals whenever questions fall outside your scope of practice.",
          "Helping people succeed with My Perfect Meals is about guidance, encouragement, and building lasting habits.",
        ],
      },
    ],
    quiz: {
      ...
      questions: [
        {
          id: "m5q1",
          question: "What is one of the most important things you can do before a client generates their first meal?",
          options: [
            "Show them every feature in the app.",
            "Help them complete their profile accurately.",
            "Skip onboarding to save time.",
            "Build a shopping list first.",
          ],
          correctIndex: 1,
          explanation: "Helping a client complete their profile accurately is one of the most valuable things you can do. The platform can only personalize using the information it has — a strong foundation leads to a better experience.",
        },
        {
          id: "m5q2",
          question: "How should you introduce My Perfect Meals to a new client?",
          options: [
            "Teach every feature during the first session.",
            "Focus on the features they need first and introduce additional tools over time.",
            "Let them figure everything out on their own.",
            "Only discuss subscription plans.",
          ],
          correctIndex: 1,
          explanation: "Start with the basics and introduce additional features as the client becomes comfortable. Learning one step at a time creates confidence, not confusion.",
        },
        {
          id: "m5q3",
          question: "What is the primary goal of My Perfect Meals?",
          options: [
            "Help users eat perfectly every day.",
            "Help users make better food decisions more consistently.",
            "Eliminate all unhealthy food choices.",
            "Replace coaching.",
          ],
          correctIndex: 1,
          explanation: "The goal is not perfection — it's helping people make better food decisions more consistently. Encourage clients to focus on progress, not perfect days.",
        },
        {
          id: "m5q4",
          question: "Which statement best describes the relationship between the platform and the coach?",
          options: [
            "The platform replaces the coach.",
            "The coach replaces the platform.",
            "The platform provides personalized nutrition guidance while the coach provides accountability and support.",
            "They perform exactly the same job.",
          ],
          correctIndex: 2,
          explanation: "The platform answers \"What should I eat?\" — the coach answers \"How do I stay consistent?\" Together they create a better experience than either could provide alone.",
        },
        {
          id: "m5q5",
          question: "A client misses a week because they were traveling. What is the best coaching response?",
          options: [
            "Tell them they failed.",
            "Encourage them to continue and focus on making the next good decision.",
            "Have them restart the entire program.",
            "Tell them the app won't work anymore.",
          ],
          correctIndex: 1,
          explanation: "One missed week doesn't erase progress. Help clients keep moving forward instead of starting over — consistency over time matters more than any single week.",
        },
        {
          id: "m5q6",
          question: "Why should new users learn the platform one step at a time?",
          options: [
            "Because the app limits features.",
            "Because learning gradually builds confidence and prevents overwhelm.",
            "Because most features don't work immediately.",
            "Because onboarding isn't important.",
          ],
          correctIndex: 1,
          explanation: "Introducing features gradually gives clients time to build confidence. Trying to learn everything at once creates confusion and reduces engagement.",
        },
        {
          id: "m5q7",
          question: "If a client asks for medical advice that is outside your scope of practice, what should you do?",
          options: [
            "Give your best guess.",
            "Search online and answer.",
            "Recommend they speak with the appropriate licensed healthcare professional.",
            "Ignore the question.",
          ],
          correctIndex: 2,
          explanation: "Knowing when to refer is part of being a trusted professional. Clients appreciate honesty, and directing them to the right resource protects both them and you.",
        },
        {
          id: "m5q8",
          question: "After completing Phase 1, what should a learner be able to do?",
          options: [
            "Diagnose medical conditions.",
            "Confidently explain, represent, and help others succeed with My Perfect Meals.",
            "Create medical treatment plans.",
            "Replace a registered dietitian.",
          ],
          correctIndex: 1,
          explanation: "Phase 1 is about understanding the platform, representing it accurately, and helping people succeed with it. That's exactly the foundation you need to move forward.",
        },
      ],
    },
  },
