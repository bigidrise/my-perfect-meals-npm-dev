  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "There is a difference between wanting to lose weight and wanting the weight off.\n\nMost people want the result.\n\nFew people want the process.\n\nSomeone who wants the weight off is ready to commit to what the process requires — the consistency, the discomfort, the patience, and the learning.\n\nSomeone who just wants to lose weight is still looking for a way to get the result without fully committing to the work.\n\nThey ask about cayenne pepper. They ask about shortcuts and hacks. They say 'I'll try it for 30 days.'\n\nNone of that language signals commitment. It signals someone who wants the outcome but is still looking for a way around the work.\n\nSuccessful coaches learn to recognize this distinction early. Not to judge — but to understand where the client is emotionally, and to meet them there.",
      },
      {
        heading: "Key Takeaway",
