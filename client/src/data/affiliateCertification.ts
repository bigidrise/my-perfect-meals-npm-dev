...
export const AFFILIATE_MODULES: CertificationModule[] = [
  {
    ...
    description: "What it means to be an MPM affiliate and how the program works.",
    estimatedMinutes: 15,
    sections: [
      {
        heading: "What Is an MPM Affiliate?",
        text: "As a My Perfect Meals affiliate, your role is straightforward: you introduce people to the platform, and when they subscribe, you earn commissions. You are not a coach, a dietitian, or a medical provider. You are a trusted referral source — someone whose audience or clients value your recommendations.",
      },
      {
        heading: "Two Affiliate Paths",
        text: "MPM offers two distinct affiliate tracks designed for different types of people and businesses.",
        list: [
          "Social & Referral Affiliate — For content creators, influencers, and individuals who promote MPM through social media, video, blogs, or word of mouth.",
          "Business & Coaching Affiliate — For trainers, coaches, wellness professionals, and business owners who actively integrate MPM into their professional practice.",
        ],
      },
      {
        heading: "Commission Structure",
        text: "Affiliates earn 30% recurring commissions on subscription payments made by referred users, for up to 24 months. Commissions are paid monthly after a minimum threshold is met. You will have a dedicated affiliate dashboard with full tracking once your certification is complete.",
      },
      {
        heading: "What You Are Endorsing",
        text: "Before you promote My Perfect Meals, you should understand what you're recommending. MPM is an AI-powered nutrition platform that generates personalized meals based on a user's dietary profile, health goals, and medical context. It is not a medical service, a coaching service, or a meal delivery service. It is a tool that helps people make better food choices in real life.",
      },
      {
        heading: "Your Responsibilities",
        list: [
          "Represent the platform accurately — only describe features that exist.",
          "Disclose your affiliate relationship clearly whenever you promote MPM.",
          "Never make medical claims or promise specific health outcomes.",
          "Refer people who will genuinely benefit from the platform.",
        ],
      },
    ],
    quiz: {
      ...
      questions: [
        {
          id: "m1q1",
          question: "What is the primary role of an MPM affiliate?",
          options: [
            "Create personalized meal plans for clients",
            "Refer people to My Perfect Meals and earn commissions",
            "Work as a coach inside the ProCare system",
            "Upload recipes to the platform",
          ],
          correctIndex: 1,
          explanation: "Affiliates refer users to My Perfect Meals and earn commissions when those users subscribe. Creating meal plans or coaching clients are separate roles.",
        },
        {
          id: "m1q2",
          question: "Which best describes the difference between a Social Affiliate and a Business & Coaching Affiliate?",
          options: [
            "Social affiliates earn higher commissions",
            "Social affiliates promote via content and social media; Business affiliates integrate MPM into their professional practice",
            "Business affiliates don't need to complete certification",
            "There is no meaningful difference between the two paths",
          ],
          correctIndex: 1,
          explanation: "Social affiliates promote through content and referrals. Business & Coaching affiliates actively use MPM as part of their professional work with clients.",
        },
        {
          id: "m1q3",
          question: "What is the MPM affiliate commission structure?",
          options: [
            "10% one-time payment per referral",
            "15% recurring for 12 months",
            "30% recurring for up to 24 months",
            "50% of the first month only",
          ],
          correctIndex: 2,
          explanation: "MPM affiliates earn 30% recurring commissions on subscription payments for up to 24 months.",
        },
        {
          id: "m1q4",
          question: "As an affiliate, you are responsible for:",
          options: [
            "Providing nutrition advice to users you refer",
            "Managing the accounts of users you refer",
            "Accurately representing the platform and disclosing your affiliate relationship",
            "Setting macro targets for users who sign up through your link",
          ],
          correctIndex: 2,
          explanation: "Affiliates represent the platform accurately and disclose their relationship. Nutrition advice, account management, and macro setting are outside the affiliate role.",
        },
        {
          id: "m1q5",
          question: "Which action would violate affiliate guidelines?",
          options: [
            "Sharing your personal experience using MPM",
            "Explaining the app's features to your audience",
            "Claiming that MPM can cure or treat a medical condition",
            "Disclosing that you earn commissions from referrals",
          ],
          correctIndex: 2,
          explanation: "Making medical claims — such as stating MPM treats or cures conditions — is a violation of affiliate guidelines and FTC rules.",
        },
      ],
    },
  },
