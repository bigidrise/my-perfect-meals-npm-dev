...
export const AFFILIATE_MODULES: CertificationModule[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Wanting To Lose Weight vs Wanting The Weight Off",
        text: "There is a critical distinction every coach must understand: there is a difference between wanting to lose weight and wanting the weight off.\n\nThis is not a small difference. It is everything.\n\nSomeone who wants the weight off will do anything to see the scale move — by any means necessary, even if it is dangerous or unsustainable. They will pursue lap band surgery. Gastric sleeve surgery. Diet pills. Extreme starvation. Crash diets. They will stop eating entirely. They will drink cayenne pepper water. They will try the grapefruit diet, the cookie diet, the liquid diet.\n\nNot because those things work. They have often already tried them. They know they do not work. But they keep coming back to them because the goal is not to change — it is just to get the weight off.\n\nThey are not looking for a method. They are looking for an escape from the work that real change requires.\n\nThis is why they will try a gimmick indefinitely — with no time limit — but will only 'give 30 days' to a real, structured program. That 30-day ceiling tells you everything. They have already decided to leave before they have even started.\n\nSomeone who wants the weight off will eventually be willing to go under a surgeon's knife before they will commit to changing what they eat.\n\nThis is the psychology most people never talk about. And it is the psychology coaches must understand before they can actually help someone.\n\nThe role of the coach is not to judge it. It is to recognize it. To understand where the client is emotionally. And then to help them shift — not by pushing harder on the method, but by helping them get honest about what they are really willing to do and why.",
      },
      {
        heading: "Key Takeaway",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "She needs a stricter calorie-restricted meal plan",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "She needs a stricter calorie-restricted meal plan immediately",
            "She is fully ready and just needs encouragement",
          ],
          correctIndex: 1,
          explanation: "The pattern is the lesson. Asking about shortcuts, hacks, and then saying 'I'll try it' signals someone who wants the outcome but is still looking for a way around the work. The issue is not food knowledge — it is commitment. An experienced coach recognizes this and works on the mindset before the meal plan.",
        },
        {
          id: "fq12",
