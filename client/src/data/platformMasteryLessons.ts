...
export const PLATFORM_MASTERY_LESSONS: PlatformMasteryLesson[] = [
    ...
    sections: [
      {
        ...
        body: "Your **assigned builder** is where most of your meal generation happens. It's selected based on your health goal, medical context, and dietary identity — and it's the tool the platform optimizes around your specific situation.\n\nThe six builders:\n\n**My Weekly Meal Builder** — Standard structured planning for users without a specific clinical context.\n\n**Diabetic Hub and Meal Builder** — Glucose-aware generation for Type 1 and Type 2 diabetes. Includes GlucoseGuard.\n\n**Metabolic Medication Hub and Builder** — Appetite-adjusted generation for GLP-1 users. Includes an injection tracker. The GLP-1 strategy established here is not limited to this builder — when GLP-1 support is active, the platform carries that intelligence across multiple food surfaces. Meal Creation, Craving Creator, Fridge Rescue, Restaurant Guide, Grocery Coach, Travel and Getaway dining, Buffet guidance, and Find Meals Near Me all account for the user's GLP-1 nutrition and tolerance needs. The Macro Calculator remains the nutritional baseline; GLP-1 support applies protein priority, meal volume, fat tolerance, and other adjustments on top of that baseline — it does not replace the baseline.\n\n**Anti-Inflammatory Meal Builder** — Inflammation-filtered generation for autoimmune conditions, joint issues, and chronic inflammation.\n\n**Performance Nutrition Hub and Builder** — Phase-aware generation for athletes with training-cycle macro adjustments. When Performance Nutrition and GLP-1 support are both active, the training schedule determines the day's performance requirements while GLP-1 tolerance and volume protections remain fully active.\n\n**General Nutrition Builder (ProCare)** — Professionally managed builder assigned by a coach or physician.\n\nYour builder handles the weekly plan. Everything else below handles everything else.",
      },
      {
  ...
  },
  {
    ...
    subtitle: "Restaurant Assistant, Find Meals Near Me, and My Perfect Buffet",
    learningObjectives: [
      "Use Restaurant Assistant to get profile-aware ordering guidance at any specific restaurant",
      "Use Find Meals Near Me to find nearby restaurants by food type or cuisine and ZIP code",
      "Use My Perfect Buffet to turn the foods available at a buffet into three personalized plate options with portion guidance",
      "Explain how the user's profile, menu disclosures, and buffet estimates shape recommendations away from home",
    ],
    opening:
      "Eating out is where most nutrition plans break down — not because one restaurant meal is catastrophic, but because there's no system for it. My Perfect Meals includes three tools for eating outside the home: Restaurant Assistant, Find Meals Near Me, and My Perfect Buffet. This lesson covers each one, when to use it, and how your profile applies when you're not in your own kitchen.",
    sections: [
      {
        heading: "Why Eating Out Needs Its Own Tools",
        body: "Most nutrition approaches treat eating out as a deviation from the plan — something to manage through willpower and vague rules like \"order the salad.\" My Perfect Meals treats it differently.\n\nEating out is predictable. It happens on work trips, family dinners, long drives, and busy weeknights. If you don't have a system for it, you'll default to guesswork every time. The three tools in this lesson give you that system.\n\nAll three tools apply your active profile. The same dietary identity, medical constraints, and macro awareness that shapes your home meals shapes every restaurant recommendation and buffet plan.",
      },
      {
        heading: "Restaurant Assistant — Guidance at Any Specific Restaurant",
        body: "Restaurant Assistant is for the moment when you know where you want to eat. It works with any specific restaurant — quick-service, full-service, local, or specialty.\n\nHow to use it:\n1. Open Lifestyle → Meals Away From Home → Restaurant Assistant\n2. Enter or select the restaurant name\n3. The platform evaluates that restaurant's available menu information against your dietary identity, medical guardrails, allergies, and current macro awareness\n4. It returns real menu options and explains what to order, what to modify, and what portions or additions to watch\n5. Review the nutrition disclosure, data source, and ordering considerations before placing your order\n\nRestaurant Assistant helps you order at the restaurant you already chose. When menu or nutrition data is limited, the disclosure identifies the confidence level so estimated information is not presented as verified.",
      },
      {
        heading: "Find Meals Near Me — Discover Nearby Options",
        body: "Find Meals Near Me is for the moment when you know what kind of food you want but do not have a specific restaurant in mind.\n\nHow to use it:\n1. Open Find Meals Near Me\n2. Enter the food type or cuisine you want\n3. Enter your ZIP code\n4. The platform finds nearby restaurant options with menu coverage and shows which options may fit your profile\n\nIt is different from Restaurant Assistant: Restaurant Assistant starts with a restaurant you already chose, while Find Meals Near Me starts with what you want to eat and helps you find a place nearby. Results depend on location and available restaurant coverage. When no suitable supported options are available, the platform should show that clearly rather than inventing a restaurant or menu item.",
      },
      {
        heading: "My Perfect Buffet — Build Three Plates From What's Available",
        body: "My Perfect Buffet is for the moment when you are standing at a buffet and need help making a plate from the foods that are actually available.\n\nEnter or describe everything you see at the buffet — proteins, vegetables, starches, sides, sauces, desserts, and other available foods. The platform evaluates those choices against your dietary identity, medical guardrails, allergies, and macro awareness.\n\nMy Perfect Buffet creates three different personalized plate options. Each plate shows which foods to choose and gives portion guidance so you can compare practical options instead of guessing at the buffet. Buffet nutrition is estimated because serving sizes and preparation vary, so read the disclosure and treat the numbers as guidance rather than laboratory precision.",
      },
      {
        heading: "What to Expect From Away-From-Home Recommendations",
        body: "Every Meals Away From Home recommendation includes information about how much confidence to place in the nutrition details.\n\n**Confidence level** — how reliable the nutrition data is for that item (manufacturer-verified, menu-estimated, or approximated).\n\n**Data source** — where the menu or food information came from.\n\n**Ordering considerations** — what to watch for when placing the order (preparation methods, portion size, common additions that change the nutrition profile).\n\n**Buffet estimates** — buffet plate nutrition is based on the foods entered and typical serving sizes, so the result is an informed estimate rather than an exact measurement.\n\nOne meal out doesn't require starting over or abandoning your plan. With profile-aware tools and honest disclosure, it is just another meal — with practical options and a clear path back to your plan afterward.",
      },
    ],
    exercise: {
      steps: [
        "Open **Lifestyle** and tap **Meals Away From Home**.",
        "Open **Restaurant Assistant** and choose a specific restaurant. Review what to order, portion guidance, modifications, and the disclosure information.",
        "Open **Find Meals Near Me**. Enter a food type or cuisine and your ZIP code, then review the nearby restaurant results.",
        "Open **My Perfect Buffet**. Enter all the foods available at a buffet, including proteins, sides, vegetables, starches, sauces, and desserts.",
        "Review the three personalized plate options and compare their recommended portion sizes.",
      ],
    },
    remember:
      "Restaurant Assistant helps you order at a specific restaurant. Find Meals Near Me finds restaurants by food type and ZIP code. My Perfect Buffet builds three portioned plates from the foods you enter. Your profile applies in all three.",
    quiz: [
      {
        id: "l5-q1",
        question:
        ...
        options: [
          "Find Meals Near Me — enter a food type and ZIP code to find a restaurant.",
          "My Perfect Buffet — enter the foods she expects to see before leaving home.",
          "Restaurant Assistant — select the restaurant and get personalized guidance on what and how to order there.",
      ...
      },
      {
        id: "l5-q2",
        question:
          "What does Restaurant Assistant provide after a user selects a specific restaurant?",
        options: [
          "A generic list of healthy foods that may not appear on that restaurant's menu.",
          "A new weekly meal plan unrelated to the restaurant.",
          "Profile-aware menu options from that restaurant, with guidance on what to order, modifications, portions, and relevant disclosures.",
          "Only the restaurant's highest-rated items, without considering the user's profile.",
        ],
        correctIndex: 2,
      },
      {
        id: "l5-q3",
        question:
          "A user wants ordering guidance at a local Mexican restaurant that is not a national chain. Which statement is correct?",
        options: [
          "Restaurant Assistant only works with national chains.",
          "She can use Restaurant Assistant for the specific restaurant; it evaluates available menu information against her profile and discloses when nutrition information is estimated.",
          "She must use My Perfect Buffet because the restaurant is local.",
          "She must use Find Meals Near Me even though she already knows the restaurant.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q4",
        question:
          "A user with Type 2 diabetes uses Restaurant Assistant at a quick-service restaurant. What should she expect to see?",
        options: [
          "All menu items ranked only by price.",
          "Only salads and water — the platform refuses to work with quick-service restaurants.",
          "Available items from that restaurant aligned with her profile, with ordering guidance and attention to high-glycemic or high-carb choices.",
          "No recommendations — restaurant tools are not available to users with medical conditions.",
        ],
        correctIndex: 2,
      },
      {
        ...
        options: [
          ...
          "When the user knows the food type or cuisine she wants, enters her ZIP code, and needs nearby restaurant options.",
          "When the user wants to build three plates from foods at a buffet.",
          "When the user wants to adapt a recipe found online.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q6",
        question:
          "A vegan user uses Restaurant Assistant at a specific restaurant that serves mostly meat-based items. What should she expect?",
        options: [
          "Meat-based items — restaurant menus override dietary identity.",
          "Only vegan-compatible options from that restaurant's available menu, if supported — her dietary identity applies the same as it does at home.",
          "No recommendations from any restaurant because vegan users must use My Perfect Buffet.",
          "A list of unrelated nearby grocery stores.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q7",
        question:
          "A user wants help eating away from home. When should she use Restaurant Assistant, Find Meals Near Me, or My Perfect Buffet?",
        options: [
          "Use Restaurant Assistant for any meal, Find Meals Near Me only for buffets, and My Perfect Buffet when she knows the restaurant name.",
          "Use Restaurant Assistant when she knows the specific restaurant and wants personalized ordering guidance. Use Find Meals Near Me when she knows the food type and ZIP code and wants nearby restaurant options. Use My Perfect Buffet when she enters the foods available at a buffet and wants three personalized plate options with portion guidance.",
          "Use Find Meals Near Me for a specific restaurant, Restaurant Assistant for grocery shopping, and My Perfect Buffet for online recipes.",
          "Use My Perfect Buffet for every restaurant meal because it always has the most accurate menu data.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q8",
        question:
          "A recommendation in Restaurant Assistant includes a disclosure note about confidence level. What does this indicate?",
        options: [
          ...
          "The restaurant has guaranteed the item will be available at every location.",
          "The user's profile is suspended while she is eating away from home.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q9",
        question:
          "How does a user's profile apply when she uses Restaurant Assistant, Find Meals Near Me, or My Perfect Buffet?",
        options: [
          "The profile is suspended for meals away from home.",
          "The profile remains active across all three tools — dietary identity, allergies, medical guardrails, and macro awareness continue to shape the guidance.",
          "Only the food type matters; medical guardrails are ignored away from home.",
          "The platform replaces the user's profile with a generic healthy-eating framework.",
        ],
        correctIndex: 1,
      },
      {
        id: "l5-q10",
        question:
          "A user is standing at a buffet and wants help building a plate from the foods available. What does My Perfect Buffet help her do?",
        options: [
          "Choose foods randomly and estimate portions without using her profile.",
          "Enter the foods available and receive three personalized plate options with recommended portion sizes.",
          "Find a nearby restaurant by entering a ZIP code.",
          "Select a specific restaurant and receive menu-based ordering instructions.",
        ],
        correctIndex: 1,
      },
    ],
    ...
    sections: [
      {
        ...
        body: "Every meal My Perfect Meals generates is shaped by a four-level constraint hierarchy. Understanding this hierarchy explains why the platform behaves the way it does — and why certain requests can't override certain profile settings.\n\n**Level 1 — Medical (highest priority)**\nIf a user has a medical condition active in their profile — Type 2 diabetes, oncology support, kidney disease, GLP-1 protocol — that condition shapes the output before anything else is considered. Medical constraints cannot be overridden by the user's request, dietary identity, or cuisine preference.\n\n**Level 2 — Dietary Identity**\nThe user's dietary category (vegan, vegetarian, keto, carnivore, halal, kosher, and others) is a firm boundary. A request that conflicts with dietary identity is redirected — not refused — toward a version that fits within that identity.\n\n**Level 3 — Cultural and Cuisine Preference**\nThe user's preferred food traditions and flavors shape the style of what's generated within the limits set by levels 1 and 2.\n\n**Level 4 — Behavioral Preference (lowest priority)**\nHeat level, cooking time, ingredient variety, and similar lifestyle preferences apply last. They influence the experience but yield to every higher-priority constraint.\n\nThis hierarchy is the reason a user with diabetes who requests a high-carb dish gets a medically appropriate alternative — the medical constraint always wins.\n\n**GLP-1 overlay and baseline preservation**\nGLP-1 support is a Level 1 medical constraint, but its relationship to the Macro Calculator baseline is additive, not replacing. The Macro Calculator sets the user's protein, carbohydrate, and fat targets. GLP-1 support then applies protein priority, meal volume limits, fat tolerance adjustments, and tolerance-phase guidance on top of that baseline. The baseline is never erased — it is resolved into what the user should actually eat given their current GLP-1 tolerance state.\n\nGLP-1 support is not confined to the Metabolic Medication Builder. When GLP-1 support is active, the canonical resolver carries that intelligence across multiple food surfaces: Meal Creation, Craving Creator, Fridge Rescue, Restaurant Guide (including Find Meals Near Me), Grocery Coach, Travel and Getaway dining, and Buffet guidance. A user does not need to be inside the GLP-1 builder for GLP-1 rules to apply to those surfaces.\n\n**GLP-1 and Performance Nutrition together**\nWhen both GLP-1 support and a Performance Nutrition protocol are active simultaneously, the systems compose without conflict. The Performance protocol determines the day's carbohydrate targets based on the training session type (power, endurance, recovery, rest). GLP-1 tolerance and volume protections remain fully active on top of those session-adjusted targets. The training schedule drives the performance layer; GLP-1 guardrails govern how those targets are expressed in actual meals.",
      },
      {
