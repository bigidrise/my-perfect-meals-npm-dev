...
export const WalkthroughRegistry: Record<string, WalkthroughStep[]> = {
  ...
  "macro-calculator": [
    ...
    { id: "step-13", text: "Now let's fine-tune your Nutrition Strategy. Cut Intensity controls how aggressive your deficit is — Standard keeps things balanced, Hard Cut dials it up. If you choose Hard Cut, you also pick a style: Balanced reduces starchy carbs moderately, while Low Carb drops them further and raises fat to keep you full.", targetId: "mc-nutrition-strategy", waitForUser: false },
    { id: "step-15", text: "Use the Starchy Carb Cap to set a hard ceiling on starchy carbs — great for people who want extra control. Leave it blank to let the calculator decide. Strict Mode turns off all auto-corrections so your macros come out exactly as calculated — useful for competition prep or ProCare programs.", targetId: "mc-nutrition-strategy", waitForUser: false },
    { id: "step-16", text: "Finally, your Starch Game Plan. Choose One Starch Meal to keep all your starchy carbs in a single meal — great for appetite control. Or choose Flex Split to spread them across two meals if that fits your schedule better. Fibrous carbs are always unlimited and stay separate.", targetId: "mc-starch-game-plan", waitForUser: false },
    { id: "complete", text: "You're all set! Your macro targets, nutrition strategy, and starch game plan are saved. Head to Biometrics to start tracking." },
  ],
  ...
  "proaccess-careteam": [
    ...
    { id: "step-27", text: "Physician-specific builder: Metabolic Med.", targetId: "pro-physician-glp1", waitForUser: false },
  ...
  "glp1-hub": [
    ...
    { id: "step-8", text: "Choose a medication preset based on your doctor's instructions.", targetId: "glp1-preset-selector", waitForUser: false },
    ...
    { id: "step-14", text: "Enter how many meals per day you're having on your medication.", targetId: "glp1-meals-per-day-input", waitForUser: false },
    { id: "step-15", text: "Tap here to activate all medication guardrails.", targetId: "glp1-save-guardrails-button", waitForUser: false },
    { id: "step-16", text: "Next, tap here to generate medication-safe meals.", targetId: "glp1-open-menu-builder-button", waitForUser: false },
    { id: "complete", text: "Perfect! You're ready to use the Metabolic Medication Hub." },
  ],
};
