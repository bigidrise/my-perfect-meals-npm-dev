...
export const WalkthroughRegistry: Record<string, WalkthroughStep[]> = {
  ...
  "macro-calculator": [
    ...
    { id: "step-14", text: "Cycle Mode lets you vary your macros day to day. Carb Cycling adjusts your starchy carbs — zero on Low days, a bonus on High days. Fat Cycling keeps carbs steady but raises or lowers fat. Once you pick a cycle, select today's Day Type: Low, Moderate, or High.", targetId: "mc-nutrition-strategy", waitForUser: false },
