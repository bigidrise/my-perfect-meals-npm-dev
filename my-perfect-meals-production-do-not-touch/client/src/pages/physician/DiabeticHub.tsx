        ...
        >
          ...
          <section className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8 mb-2 relative overflow-hidden">
            ...
            <button
              ...
              className="w-full px-6 py-3 rounded-xl bg-orange-500/90 backdrop-blur-sm hover:bg-orange-700/90 text-white font-medium transition-all shadow-xl border-2 border-orange-300/90 relative overflow-hidden disabled:opacity-50"
            >
            ...
            <div className="grid md:grid-cols-2 gap-6 relative z-10">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-6 py-4 rounded-xl bg-orange-500/90 backdrop-blur-sm hover:bg-orange-600/90 text-md text-white font-semi-bold transition-all shadow-xl border-2 border-orange-300/90 relative overflow-hidden disabled:opacity-50"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-transparent to-white/5 pointer-events-none" />
                  <span className="relative z-10">
          ...
          <section className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8 mb-2 relative overflow-hidden">
            ...
            <button
              ...
              className="w-full px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-orange-500 hover:from-orange-700 hover:to-orange-700 text-white font-semibold transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 border-2 border-orange-300/90 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-transparent to-white/5 pointer-events-none" />
