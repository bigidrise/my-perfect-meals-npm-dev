...
const GLP1MealBuilderScript: WalkthroughScript = {
  id: "glp1-meal-builder",
  featureId: "GLP1_MEAL_BUILDER",
  ...
  steps: [
    {
      ...
      description: "Welcome to the GLP-1 Meal Builder. Let's create your first day. We'll begin with breakfast.",
      message: "Welcome to the GLP-1 Meal Builder. Let's create your first day. We'll begin with breakfast.",
      speak: "Welcome to the GLP-1 Meal Builder. Let's create your first day.",
      spotlight: true,
    },
    {
      id: "breakfast",
...
export default GLP1MealBuilderScript;
