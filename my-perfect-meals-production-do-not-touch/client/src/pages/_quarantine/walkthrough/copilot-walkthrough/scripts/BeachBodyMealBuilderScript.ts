...
const BeachBodyMealBuilderScript: WalkthroughScript = {
  id: "beach-body-meal-builder",
  featureId: "BEACH_BODY_MEAL_BUILDER",
  ...
  steps: [
    {
      ...
      description: "Welcome to the Beach Body Builder. Let's create your first day. We'll begin with breakfast.",
      message: "Welcome to the Beach Body Builder. Let's create your first day. We'll begin with breakfast.",
      speak: "Welcome to the Beach Body Builder. Let's create your first day.",
      spotlight: true,
    },
    {
      id: "breakfast",
...
export default BeachBodyMealBuilderScript;
