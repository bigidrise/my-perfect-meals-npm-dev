...
**How to apply:** Preserve the original wording. Known catalog matches stay deterministic. High-confidence prepared-dish, ingredient-led, open-world ingredient, and cuisine-led requests continue without requiring a catalog entry. Catalog absence must not remove the preparation experience: semantic choices use server-created preference IDs and remain creative intent, never governed evidence. Only genuine ambiguity asks for clarification. Non-food and adversarial input stays blocked. Every accepted request still passes the complete dietary, allergy, clinical, Human Food, dish-identity, and final-result validation stack.