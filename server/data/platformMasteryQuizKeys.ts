...
export const QUIZ_ANSWER_KEYS: Record<string, number[]> = {
  ...
  "lesson-02": [2, 1, 2, 2, 1, 2, 0, 2, 1, 2],
  "lesson-03": [2, 1, 2, 1, 2, 3, 2, 1, 1, 2],
  "lesson-04": [3, 2, 2, 2, 2, 1, 1, 3, 2, 1],
  "lesson-05": [2, 2, 1, 2, 1, 1, 2, 1, 1, 1],
  "lesson-06": [1, 2, 2, 2, 2, 2, 2, 2, 2, 1],
  "lesson-07": [2, 1, 1, 2, 1, 2, 1, 2, 1, 3],
  "lesson-08": [2, 2, 2, 3, 2, 1, 2, 1, 2, 1, 2, 1],
  "lesson-09": [1, 2, 1, 3, 1, 2, 2, 1, 2, 2],
};
