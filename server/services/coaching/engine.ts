...
async function runRenderingPass(params: {
  ...
  const systemPrompt = [
    ...
    "  Forbidden language: 'I'm adjusting your targets', 'this will fix it', 'your problem is X',",
    "  'I'm changing your plan to'. These are medical/clinical determinations—not yours to make.",
