...
Additionally, preserve the traditional protein form and preparation method — do NOT substitute traditional cuts with modern "lean" alternatives (e.g., do NOT replace bone-in chicken with chicken breast in Doro Wat, do NOT replace pork belly with lean pork loin in a dish that requires it). The specific cut, bone structure, and preparation context are part of the dish's identity and must be respected.
